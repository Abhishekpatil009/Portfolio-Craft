...
export const metadata = {
  ...
  authors: [
    { name: 'Abhishek Patil', url: 'https://www.linkedin.com/in/abhishek-patil01/' },
  ],
  creator: 'Abhihshek Patil',
  // icons: { icon: '' },
  openGraph: {
    title: 'AP',
    description:
      'Abhishek Patil DEV, website and web application development.',
    type: 'website',
    locale: 'en_US',
    url: 'https://portfolio-craft-two.vercel.app/',
  },
  applicationName: 'AP',
  description:
    'Abhishek Patil DEV, website and web application development.',
  ...
  alternates: {
    canonical: 'https://portfolio-craft-two.vercel.app/',
    languages: {
      'en-US': 'https://portfolio-craft-two.vercel.app/',
    },
  },
}
